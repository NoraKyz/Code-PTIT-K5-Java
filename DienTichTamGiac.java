...
class Triangle
{
    ...
    public String toString()
    {
        ...
        return String.format("%.2f", this.getSurface());
    }
}
...
public class DienTichTamGiac {
  ...
  public static void main(String[] args) {
    ...
    while(t-- > 0) {
      Triangle triangle = new Triangle(sc.nextDouble(), sc.nextDouble(), sc.nextDouble(), sc.nextDouble(), sc.nextDouble(), sc.nextDouble());
